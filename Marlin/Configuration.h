...
// Don't want to drop this but it removing STRING_CONFIG_H_AUTHOR saves us some firmware space
//#define STRING_CONFIG_H_AUTHOR "Thomas Toka fork" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

// @section machine
#if ENABLED(E3S1PRO_RTS)
  #define FORK_VERSION "v038"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 127.12
  #define DEFAULT_BED_KI 23.03
  #define DEFAULT_BED_KD 476.81
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, -41.8, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MAX_POS - 50), 20 }
